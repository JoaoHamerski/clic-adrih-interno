    ...
    */
    ...
    'custom' => [
        ...
        'installments.*.due_date' => [
            'required' => 'Informe a data de vencimento desta parcela'
        ],    
        'trade_name.required_if' => 'Por favor, informe o nome fantasia.',
        'company_name.required_if' => 'Por favor, informe a razão social.',
        'cpf' => [
            'required_if' => 'Por favor, informe o CPF.',
            'unique' => 'O CPF informado já está sendo utilizado.',
            'cpf' => 'Por favor, informe um CPF válido.'
        ],
        'cnpj' => [
            'required_if' => 'Por favor, informe o CNPJ.',
        ...
        'phone.*' => [
            ...
            'min' => 'O numero de telefone deve ter no mínimo :min digitos.'
        ],
        'email' => [
            'required' => 'Por favor, informe um e-mail.',
            'email' => 'O endereço de e-mail informado é inválido.',
            'unique' => 'O endereço de e-mail informado já está sendo utilizado.'
        ],
        'password' => [
            'required' => 'Por favor, informe uma senha.',
            'min' => 'A senha deve conter no mínimo :min caracteres.',
            'confirmed' => 'A senha de confirmação não confere.'
        ],
        'date_of_birth' => [
